...
@section('title', 'Vestuário Feminino - Feira das Fábricas')

@section('styles')
<style>
    /* Elegant Theme - Vestuário Feminino */
    :root {
        --elegant-dark: #0f172a;
        --elegant-blue: #1e293b;
    ...
    .hero-default-bg {
        background: linear-gradient(135deg, #FF8C00 0%, #E67700 50%, #CC6B00 100%);
    }
    ...
    .hero-banner-overlay {
        ...
        right: 0;
        bottom: 0;
        background: linear-gradient(135deg, rgba(255, 140, 0, 0.7) 0%, rgba(230, 119, 0, 0.5) 50%, rgba(204, 107, 0, 0.3) 100%);
        display: flex;
        align-items: center;
    }
    ...
    .product-info {
        ...
        flex-grow: 1;
        background: linear-gradient(180deg, rgba(255,255,255,0.9) 0%, rgba(252,228,236,0.8) 100%);
    }
                        ...
                        <div class="col-lg-8">
                            <div class="hero-banner-content">
                                ...
                                <p class="hero-banner-subtitle">
                                    Moda feminina com elegância e estilo. Roupas, calçados e acessórios exclusivos para mulheres.
                                </p>
                                <div class="hero-banner-actions">
                                    <a href="{{ route('products') }}?department=vestuario-feminino" class="btn hero-btn-primary">
...
<section class="section-gray">
    <div class="container">
        ...
        <p class="section-subtitle">
            Seleção especial de produtos femininos para seu estilo único
        </p>
        <!-- Carrossel de Produtos -->
...
<section class="section-elegant" style="padding: 20px 0;">
    <div class="container">
        <div class="text-center">
            <a href="{{ route('products') }}?department=vestuario-feminino" class="btn" style="background: var(--elegant-accent); color: white; padding: 15px 35px; font-size: 1.1rem; font-weight: 600; border-radius: 50px; transition: all 0.3s ease; box-shadow: 0 8px 25px rgba(255, 140, 0, 0.3);">
                Ver Todos os Produtos Femininos
    ...
    <div class="container">
        <div class="category-section">
            <div class="category-header">
                ...
                <h2 class="category-title">Roupas Femininas</h2>
                <p class="category-subtitle">
                    Descubra nossa coleção de roupas femininas com estilo, conforto e elegância
                </p>
            </div>
            ...
            <div class="text-center py-5">
                <div class="empty-state">
                    ...
                    <h4 class="text-muted">Coleção Feminina em Expansão</h4>
...
<!-- Seção Calçados Femininos -->
<section class="section-gray">
    <div class="container">
        <div class="category-section">
            <div class="category-header">
                <i class="fas fa-shoe-prints category-icon"></i>
                <h2 class="category-title">Calçados Femininos</h2>
                <p class="category-subtitle">
                    Conforto e estilo para seus pés com nossa linha de calçados femininos
                </p>
            </div>
            ...
            <div class="text-center py-5">
                <div class="empty-state">
                    ...
                    <h4 class="text-muted">Calçados Femininos em Breve</h4>
                    <p class="text-muted">Estamos preparando uma seleção especial de calçados femininos para você!</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Seção Acessórios Femininos -->
<section class="section-elegant">
    <div class="container">
        <div class="category-section">
            <div class="category-header">
                <i class="fas fa-gem category-icon"></i>
                <h2 class="category-title">Acessórios Femininos</h2>
                <p class="category-subtitle">
                    Complete seu look com nossos acessórios exclusivos para mulheres
                </p>
            </div>
            ...
            <div class="text-center py-5">
                <div class="empty-state">
                    ...
                    <h4 class="text-muted">Acessórios Femininos em Breve</h4>
                    <p class="text-muted">Estamos preparando uma seleção especial de acessórios femininos para você!</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section-gray">
    <div class="container">
        <div class="b2b-section" style="background: linear-gradient(135deg, var(--elegant-dark) 0%, var(--elegant-blue) 50%, var(--elegant-light) 100%); color: white; padding: 60px; border-radius: 20px; text-align: center; box-shadow: 0 8px 32px rgba(15, 23, 42, 0.3);">
            ...
            <a href="{{ route('register.b2b') }}" class="btn b2b-btn" style="background: var(--elegant-accent); color: white; border: none; padding: 15px 35px; font-size: 1.1rem; font-weight: 600; border-radius: 50px; transition: all 0.3s ease; box-shadow: 0 8px 25px rgba(255, 140, 0, 0.3);">
