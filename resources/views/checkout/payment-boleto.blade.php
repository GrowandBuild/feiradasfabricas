...
@section('title', 'Pagamento Boleto - Finalizar Compra')
                ...
                <div class="payment-content">
                    ...
                    @if(isset($checkoutData['payment_url']) && $checkoutData['payment_url'])
                        <div class="boleto-container">
                            <div class="boleto-header">
                                <h5><i class="fas fa-barcode me-2"></i>Código de Barras</h5>
                                <p>Use este código para pagar em qualquer banco ou casa lotérica</p>
                            </div>
                            ...
                            <div class="boleto-instructions">
                                <h6><i class="fas fa-list-ol me-2"></i>Como Pagar:</h6>
                                <ol>
                                    <li>Copie o código de barras acima</li>
                                    <li>Acesse o site do seu banco ou use o app</li>
                                    <li>Selecione "Pagar Boleto" ou "Pagar Conta"</li>
                            ...
                            <div class="action-buttons">
                                <button onclick="copyBoletoCode()" class="btn-boleto">
                    ...
                    @else
                        <div class="boleto-container">
                            <div class="boleto-header">
                                <h5><i class="fas fa-barcode me-2"></i>Código de Barras</h5>
                                <p>Erro ao gerar boleto</p>
                            </div>
                            
                            <div class="error-message show">
                                <i class="fas fa-exclamation-triangle me-2"></i>
                                Erro ao gerar boleto. Entre em contato conosco.
                            </div>
                        </div>
                    @endif
...
function copyBoletoCode() {
    const boletoCode = document.getElementById('boletoCode').textContent;
...
// Verificação automática a cada 30 segundos (boleto demora mais para ser processado)
