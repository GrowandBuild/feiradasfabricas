...
@section('title', 'Criar Selo')
@section('page-title', 'Criar Novo Selo de Marca')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.department-badges.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">
                            ...
                            Recomendado: Imagem quadrada (ex: 200x200px) para melhor visualização
                        </small>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle"></i> Criar Selo
                        </button>
                    </div>
                </form>
            </div>
