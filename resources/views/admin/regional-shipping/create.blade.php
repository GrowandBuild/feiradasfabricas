...
@section('title', 'Nova Região de Entrega')
@section('page-title', 'Criar Nova Região de Entrega')
...
<div class="row">
    <div class="col-lg-10">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.regional-shipping.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      ...
                                      placeholder="Descrição opcional da região">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('cep_start') is-invalid @enderror"
                                       id="cep_start" name="cep_start" value="{{ old('cep_start') }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('cep_end') is-invalid @enderror"
                                       id="cep_end" name="cep_end" value="{{ old('cep_end') }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('cep_list') is-invalid @enderror"
                                   id="cep_list" name="cep_list" value="{{ old('cep_list') }}" 
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('pricing_type') is-invalid @enderror" 
                                ...
                                <option value="fixed" {{ old('pricing_type', 'fixed') == 'fixed' ? 'selected' : '' }}>Preço Fixo</option>
                                <option value="per_weight" {{ old('pricing_type') == 'per_weight' ? 'selected' : '' }}>Por Peso (R$/kg)</option>
                                <option value="per_item" {{ old('pricing_type') == 'per_item' ? 'selected' : '' }}>Por Item (R$/unidade)</option>
                            </select>
                            @error('pricing_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div id="pricing-fields">
                            <!-- Preço Fixo -->
                            <div class="row pricing-field" data-type="fixed" style="display: {{ old('pricing_type', 'fixed') == 'fixed' ? 'block' : 'none' }};">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" 
                                           ...
                                           value="{{ old('fixed_price') }}" placeholder="0.00">
                                    @error('fixed_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <!-- Por Peso -->
                            <div class="row pricing-field" data-type="per_weight" style="display: {{ old('pricing_type') == 'per_weight' ? 'block' : 'none' }};">
                                <div class="col-md-6 mb-3">
                            ...
                            <!-- Por Item -->
                            <div class="row pricing-field" data-type="per_item" style="display: {{ old('pricing_type') == 'per_item' ? 'block' : 'none' }};">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" 
                                           ...
                                           value="{{ old('price_per_item') }}" placeholder="0.00">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('delivery_days_min') is-invalid @enderror"
                                       ...
                                       value="{{ old('delivery_days_min', 1) }}" min="1" max="60" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('delivery_days_max') is-invalid @enderror"
                                       ...
                                       value="{{ old('delivery_days_max') }}" min="1" max="60">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-lg"></i> Salvar Região
                        </button>
                    </div>
                </form>
            </div>
